...
export class CreateHotelDto {
  @IsNotEmpty({ message: 'Loại khách sạn (hotelTypeId) không được để trống' })
  @Type(() => Number)
  ...
  @IsNotEmpty({ message: 'Địa điểm (locationId) không được để trống' })
  @Type(() => Number)
  ...
  @IsNotEmpty({ message: 'Địa chỉ khách sạn không được để trống' })
